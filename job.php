...
<span class="menuselect"><a class = "menu" href="job.php">Job</a></span>
???
???
???
</b>
...
// @abstract  the session has the login information 
{
	...
	<div style="position:absolute; right:150px; width:160px;"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?logout=out">Disconnect/Change Database</a></div>
	<div class = "tab">
		<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">  
...
?>
  <?php
  $mysqli = mysqli_connect("localhost", "root", "gnombe", "job");
...
<tr>
<td><a href="Company/view.php" class="big">Companies </a> </td>
<td><a href="Company/new.php"class="big">Create </a>  </td>

</tr>
<tr>
<td><a href="Facts/view.php"class="big"  >-Facts </a> </td> 
<td><a href="Facts/new.php" class="big" >Create </a>   </td>

</tr>
<tr>
<td><a href="Jobs/view.php"class="big">Jobs </a>  </td>
<td><a href="Jobs/new.php"class="big">Create </a>   </td>

</tr>
<tr>
<td><a href="Contact/view.php" class="big" >-Contact </a>  </td>
<td><a href="Contact/new.php" class="big" >Create </a>   </td>

</tr>
<tr>
<td><a href="Conversation/view.php" class="big" >-Conversation </a></td>
<td><a href="Conversation/new.php" class="big" >Create </a>   </td>

</tr>
<tr>
<td><a href="Resume/view.php"class="big"  >-Resume </a>  </td>
<td><a href="Resume/new.php"class="big"  >Create </a>   </td>

</tr>
<tr>
<td><a href="CoverLetter/view.php"class="big"  >-CoverLetter </a> </td> 
<td><a href="CoverLetter/new.php" class="big" >Create </a>   </td>

</tr>
<tr>
<td><a href="Skill/view.php"class="big"  >-Skill </a> </td> 
<td><a href="Skill/new.php" class="big" >Create </a>   </td>

</tr>
<tr>
<td><a href="Questions/view.php"class="big"  >-Question </a> </td> 
<td><a href="Questions/new.php" class="big" >Create </a>   </td>

</tr>
<tr>
<td><a href="Answers/view.php"class="big"  >-Answer </a> </td> 
<td><a href="Answers/new.php" class="big" >Create </a>   </td>
